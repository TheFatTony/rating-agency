package com.chieftain.agency.aws;
...
public class S3Wrapper {
    ...
    private PutObjectResult upload(String filePath, String uploadKey) throws IOException {
    ...
    public PutObjectResult upload(InputStream fileInputStream,
                                  FormDataContentDisposition fileMetaData) throws IOException {
